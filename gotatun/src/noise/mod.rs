...
mod tests {
    ...
    fn handshake_jitter_applied() {
        ...
        // RNG always returns 200; jitter = 200 % (MAX_JITTER + 1) = 200 ms.
        let mut jitter_rng = FixedRng(200);
        let expected_jitter = jitter_rng.random_range(Duration::ZERO..=MAX_JITTER);
