...
/// Ensures setting a peer's preshared key via Device::modify_peer propagates into its noice state
#[tokio::test]
#[test_log::test]
...
/// Ensures setting a peer's preshared key via Device::update_peer propagates into its noice state
#[tokio::test]
#[test_log::test]
