...
pub fn bench_assemble_ipv4_fragment(c: &mut Criterion) {
...
pub fn bench_assemble_ipv4_fragment_reverse_order(c: &mut Criterion) {
    let mut fragments = Ipv4Fragments::default();
...
pub fn bench_assemble_ipv4_fragment_interleaved(c: &mut Criterion) {
    let mut fragments = Ipv4Fragments::default();
